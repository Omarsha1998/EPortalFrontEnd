<template>
  ...
  <div class="borderStyle">
    <div
      class="row bg-white"
      v-for="(value, property) in this.familyBackgrounds.parents.father"
      :key="property"
    >
...
export default {
  ...
  methods: {
    ...
    getEditDefaultValues: function () {
      const response = {
        submit: {
          full_name: this.familyBackgrounds.parents.father.full_name,
          request_type: "edit",
          family_type: "Father",
          birth_date: this.getBirthDate(
            this.familyBackgrounds.parents.father.birth_date
          ),
          employee_id: this.employeeID,
          occupation: this.familyBackgrounds.parents.father.occupation,
          company_name: this.familyBackgrounds.parents.father.company_name,
        },
      };
      return response;
    },
