              ...
              <div>
                <q-card class="roundedd">
                  ...
                  <q-card-section v-if="!loading">
                        ...
                        <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy ref="dateFromPopup" :breakpoint="1440" cover>
                            <div class="q-date-container">
                              ...
                              <q-btn elevated icon="close" @click="hidePopup('dateFromPopup')" class="absolute-top-right" round padding="xs" style="margin: 10px; color: white;"></q-btn>
                            </div>
                          </q-popup-proxy>
                        </q-icon>
                      </template>
                        ...
                        <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy ref="dateToPopup" :breakpoint="1440" cover>
                            <div class="q-date-container">
                              ...
                              <q-btn elevated icon="close" @click="hidePopup('dateToPopup')" class="absolute-top-right" round padding="xs" style="margin: 10px; color: white;"></q-btn>
                            </div>
                          </q-popup-proxy>
                        </q-icon>
                      </template>
                    ...
                    <div v-if="Days > 1">
                      <q-input filled label="Time From" v-model="TimeFrom" @click="showPopup('TimeFromPopup')" style="margin-bottom: 5px;" disable>
                        <template v-slot:append>
                          <q-icon name="schedule" class="cursor-pointer">
                            <q-popup-proxy ref="TimeFromPopup" :breakpoint="1440" cover>
                              <div class="q-date-container">
                                <q-time v-model="TimeFrom" mask="h:mm A"></q-time>
                                <q-btn elevated icon="close" @click="hidePopup('TimeFromPopup')" class="absolute-top-right" round padding="xs" style="margin: 10px; color: white;"></q-btn>
                              </div>
                            </q-popup-proxy>
                          </q-icon>
                        </template>
                      </q-input>
                      <q-input filled label="Time To" v-model="TimeTo" @click="showPopup('TimeToPopup')" style="margin-bottom: 5px;" disable>
                        <template v-slot:append>
                          <q-icon name="schedule" class="cursor-pointer">
                            <q-popup-proxy ref="TimeToPopup" :breakpoint="1440" cover>
                              <div class="q-date-container">
                                <q-time v-model="TimeTo" mask="h:mm A"></q-time>
                                <q-btn elevated icon="close" @click="hidePopup('TimeToPopup')" class="absolute-top-right" round padding="xs" style="margin: 10px; color: white;"></q-btn>
                              </div>
                            </q-popup-proxy>
                          </q-icon>
                        </template>
                  ...
                  <q-icon name="event" class="cursor-pointer">
                    <q-popup-proxy ref="dateFromPopup2" :breakpoint="1440" cover>
                      <div class="q-date-container">
                        ...
                        <q-btn elevated icon="close" @click="hidePopup('dateFromPopup2')" class="absolute-top-right" round padding="xs" style="margin: 10px; color: white;"></q-btn>
                      </div>
                    </q-popup-proxy>
                  </q-icon>
                </template>
                  ...
                  <q-icon name="event" class="cursor-pointer">
                    <q-popup-proxy ref="dateToPopup2" :breakpoint="1440" cover>
                      <div class="q-date-container">
                        ...
                        <q-btn elevated icon="close" @click="hidePopup('dateToPopup2')" class="absolute-top-right" round padding="xs" style="margin: 10px; color: white;"></q-btn>
                      </div>
                    </q-popup-proxy>
                  </q-icon>
                </template>
                  ...
                  <q-icon name="schedule" class="cursor-pointer">
                    <q-popup-proxy ref="TimeFromPopup2" :breakpoint="1440" cover>
                      <div class="q-date-container">
                        ...
                        <q-btn elevated icon="close" @click="hidePopup('TimeFromPopup2')" class="absolute-top-right" round padding="xs" style="margin: 10px; color: white;"></q-btn>
                      </div>
                    </q-popup-proxy>
                  </q-icon>
                </template>
                  ...
                  <q-icon name="schedule" class="cursor-pointer">
                    <q-popup-proxy ref="TimeToPopup2" :breakpoint="1440" cover>
                      <div class="q-date-container">
                        ...
                        <q-btn elevated icon="close" @click="hidePopup('TimeToPopup2')" class="absolute-top-right" round padding="xs" style="margin: 10px; color: white;"></q-btn>
                      </div>
                    </q-popup-proxy>
                  </q-icon>
                </template>
